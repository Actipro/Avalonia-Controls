...
page-title: "Getting Started - Data Visualization Reference"
order: 2
---
# Getting Started
...
Data Visualization is included with the `ActiproSoftware.Controls.Avalonia.Pro` package ([view on nuget.org](https://www.nuget.org/packages/ActiproSoftware.Controls.Avalonia.Pro)), so add a reference to that package. This should automatically include its transient dependencies as well.
...
See the [Barcodes Overview](barcodes/index.md) for topics related to presenting barcodes and the various symbologies that are supported.
...
See the [Samples](../samples.md) topic for more information on accessing the sample project.