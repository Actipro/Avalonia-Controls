...
public class RibbonFooterContentTemplateSelector : IDataTemplateSelector {
	...
	public RibbonFooterContentTemplateSelector() {
		InfoBarDataTemplate = FindDataTemplateResource(BarsMvvmResourceKeys.RibbonFooterContentInfoBarDataTemplate);
		SimpleDataTemplate = FindDataTemplateResource(BarsMvvmResourceKeys.RibbonFooterContentSimpleDataTemplate);
	}
	...
	public virtual IDataTemplate? SelectTemplate(object? item, Control? container) {
		return item switch {
			RibbonFooterInfoBarContentViewModel => InfoBarDataTemplate,
			RibbonFooterSimpleContentViewModel => SimpleDataTemplate,
			_ => null
		};
	}
