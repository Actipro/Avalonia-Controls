...
public partial class MainControl : UserControl {
	...
	public MainControl() {
		...
		// Synchronize other popup menu UI options with the view models
	...
	private static IImage? GetViewModelLargeIcon(string key)
		=> ImageLoader.GetIcon($"{key}32.png");

	private static IImage? GetViewModelSmallIcon(string key)
	...
	private void UpdatePopupMenuViewModels() {
		var staysOpenOnClick = (basicUsagePopupMenuStaysOpenOnClickCheckBox.IsChecked == true);
		var showIcons = (basicUsagePopupMenuShowIconsCheckBox.IsChecked == true);
	...
	/// </summary>
	public ObservableCollection<TagColorGalleryItem> TagColors { get; } = [..TagColorGalleryItem.CreateDefaultCollection()];
