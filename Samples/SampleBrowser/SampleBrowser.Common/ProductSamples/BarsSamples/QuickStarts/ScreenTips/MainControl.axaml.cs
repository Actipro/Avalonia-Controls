...
public partial class MainControl : UserControl {
	...
	/// </summary>
	public BarButtonViewModel? BasicUsageBarButtonViewModel
		=> BasicUsageRibbonViewModel.Tabs[0].Groups[0].Items[0] as BarButtonViewModel;
	...
	private void OnInputElementKeyDown(InputElement sender, KeyEventArgs e) {
		...
		if (e is { Handled: false, Key: Key.F1 }) {
