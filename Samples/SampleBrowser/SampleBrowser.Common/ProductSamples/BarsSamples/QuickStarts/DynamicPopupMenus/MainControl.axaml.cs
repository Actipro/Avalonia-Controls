...
public partial class MainControl : UserControl {
	...
	/// </summary>
	private BarMenuFlyout CreateTextBoxContextFlyout() {
		// Configure the menu
	...
	private void OnRibbonMenuOpeningMvvm(object? sender, BarMenuEventArgs e) {
		...
		if (e.Kind is (BarMenuKind.PopupButtonMenu or BarMenuKind.MenuItemSubmenu))
	...
	private void PopulateOpenDocumentMenuItemsMvvm(IList menuItems) {
		...
		_recentDocuments ??= [.. RecentDocumentHelper.CreateDefaultItems()];
