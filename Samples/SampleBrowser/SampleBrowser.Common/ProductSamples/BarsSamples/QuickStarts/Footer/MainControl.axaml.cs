...
public partial class MainControl : UserControl {
	...
	private static readonly ICommand DisabledCommand = new DelegateCommand<object>(_ => { /* no op */ }, _ => false);
	...
	/// <summary>
	/// The view model for the footer used by the "Basic usage" MVVM-based sample.
	/// </summary>
	...
	/// <summary>
	/// The view model for the footer used by the "Info bar usage" MVVM-based sample.
	/// </summary>
	...
	private void ShowMvvmFooter() {
		...
		InfoBarUsageRibbonViewModel.Footer = InfoBarUsageFooterViewModel;
	}
	...
	public BasicUsageOptionsViewModel BasicUsageOptions {
		get {
			if (_basicUsageOptionsViewModel is null) {
				...
				_basicUsageOptionsViewModel.PropertyChanged += OnBasicUsageOptionsViewModelPropertyChanged;
			}
	...
	public InfoBarUsageOptionsViewModel InfoBarUsageOptions {
		get {
			if (_infoBarUsageOptionsViewModel is null) {
				...
				_infoBarUsageOptionsViewModel.PropertyChanged += OnInfoBarUsageOptionsViewModelPropertyChanged;
			}
