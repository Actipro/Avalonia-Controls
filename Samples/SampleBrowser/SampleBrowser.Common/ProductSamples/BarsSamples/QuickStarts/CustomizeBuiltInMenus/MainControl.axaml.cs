...
public partial class MainControl : UserControl {
	...
	private ICommand CustomCommand { get; } = new DelegateCommand<object>(param => {
	...
	private void OnRibbonMenuOpening(object? sender, BarMenuEventArgs e) {
		...
		bool isBuiltInMenu = (e.Kind is not (BarMenuKind.PopupButtonMenu or BarMenuKind.MenuItemSubmenu));
		if (isBuiltInMenu)
			CustomizeMenu(e);
	}
