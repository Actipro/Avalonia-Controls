...
public partial class MainControl : UserControl {
	...
	public MainControl() {
		...
		BasicUsageRibbonViewModel.PropertyChanged += OnBasicUsageRibbonViewModelPropertyChanged;
	...
	/// </summary>
	private static RibbonViewModel CreateCommonItemsRibbonViewModel() {
	...
	/// </summary>
	private static RibbonViewModel CreateOverflowScenarioRibbonViewModel() {
	...
	public BasicUsageOptionsViewModel BasicUsageOptions {
		get {
			if (_basicUsageOptionsViewModel is null) {
				...
				_basicUsageOptionsViewModel.PropertyChanged += OnOptionsViewModelPropertyChanged;
			}
