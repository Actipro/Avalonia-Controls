...
CHANGES SINCE LAST STEP:
	...
	Added CompositeCommand property for SelectAllCommand.
...
public class SampleBarManager {
	...
	private void RegisterControlViewModels() {
		...
		/*(New)*/ ControlViewModels.Register(SampleBarControlKeys.SelectAll,
			key => new BarButtonViewModel(key, SelectAllCommand) {
				Description = "Select all text and objects.",
	...
	/// </summary>
	public CompositeCommand CopyCommand { get; } = new();

	/// <summary>
	/// The composite command for clipboard cut operations.
	/// </summary>
	public CompositeCommand CutCommand { get; } = new();

	/// <summary>
	/// The command for displaying Help.
	/// </summary>
	public ICommand HelpCommand { get; } = new DelegateCommand<object>(param => {
			// Execute
	...
	/// </summary>
	public static ICommand NotImplementedCommand { get; } = new DelegateCommand<object>(param => {
			MessageBox.Show(
	...
	/// </summary>
	public CompositeCommand PasteCommand { get; } = new();

	/// <summary>
	/// The composite command for redo operations.
	/// </summary>
	public CompositeCommand RedoCommand { get; } = new();

	/// <summary>
	/// The composite command for select all operations.
	/// </summary>
	/*(NEW)*/ public CompositeCommand SelectAllCommand { get; } = new();

	/// <summary>
	/// The composite command for undo operations.
	/// </summary>
	public CompositeCommand UndoCommand { get; } = new();
