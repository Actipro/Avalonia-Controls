...
public class SampleBarManager {
	...
	/// </summary>
	/*(New)*/ public CompositeCommand CopyCommand { get; } = new();

	/// <summary>
	/// The composite command for clipboard cut operations.
	/// </summary>
	/*(New)*/ public CompositeCommand CutCommand { get; } = new();
	...
	/// </summary>
	/*(New)*/ public CompositeCommand PasteCommand { get; } = new();

	/// <summary>
	/// The composite command for redo operations.
	/// </summary>
	/*(New)*/ public CompositeCommand RedoCommand { get; } = new();

	/// <summary>
	/// The composite command for undo operations.
	/// </summary>
	/*(New)*/ public CompositeCommand UndoCommand { get; } = new();
