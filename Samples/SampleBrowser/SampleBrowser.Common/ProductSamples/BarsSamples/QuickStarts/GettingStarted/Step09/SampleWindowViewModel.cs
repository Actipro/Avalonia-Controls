...
public class SampleWindowViewModel : ObservableObjectBase {
	...
	/// </summary>
	private SampleBarManager BarManager { get; } = new();
	...
	private static void UpdateCommandAndCompositeRegistration(ref ICommand? currentValue, ICommand? newValue, CompositeCommand compositeCommand) {
