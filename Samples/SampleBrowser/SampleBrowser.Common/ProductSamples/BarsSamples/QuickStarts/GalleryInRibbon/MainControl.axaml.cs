...
public partial class MainControl : UserControl {
	...
	internal static ICollectionView CreateColorItems() {
		...
		return BarGalleryViewModel.CreateCollectionView(new ColorBarGalleryItemViewModel[] {
			new(UIColor.Parse("#eeece1"), neutralColorsCategory, "Tan"),
			new(UIColor.Parse("#ddd9c3"), neutralColorsCategory, "Tan, Darker 10%"),
			new(UIColor.Parse("#c4bd97"), neutralColorsCategory, "Tan, Darker 25%"),
			new(UIColor.Parse("#938953"), neutralColorsCategory, "Tan, Darker 50%"),
			new(UIColor.Parse("#494429"), neutralColorsCategory, "Tan, Darker 75%"),
			new(UIColor.Parse("#1d1b10"), neutralColorsCategory, "Tan, Darker 90%"),

			new(UIColor.Parse("#1f497d"), coolColorsCategory, "Dark Blue"),
			new(UIColor.Parse("#c6d9f0"), coolColorsCategory, "Dark Blue, Lighter 80%"),
			new(UIColor.Parse("#8db3e2"), coolColorsCategory, "Dark Blue, Lighter 60%"),
			new(UIColor.Parse("#548dd4"), coolColorsCategory, "Dark Blue, Lighter 40%"),
			new(UIColor.Parse("#17365d"), coolColorsCategory, "Dark Blue, Darker 25%"),
			new(UIColor.Parse("#17365d"), coolColorsCategory, "Dark Blue, Darker 50%"),

			new(UIColor.Parse("#4f81bd"), coolColorsCategory, "Blue"),
			new(UIColor.Parse("#dbe5f1"), coolColorsCategory, "Blue, Lighter 80%"),
			new(UIColor.Parse("#b8cce4"), coolColorsCategory, "Blue, Lighter 60%"),
			new(UIColor.Parse("#95b3d7"), coolColorsCategory, "Blue, Lighter 40%"),
			new(UIColor.Parse("#366092"), coolColorsCategory, "Blue, Darker 25%"),
			new(UIColor.Parse("#244061"), coolColorsCategory, "Blue, Darker 50%"),

			new(UIColor.Parse("#c0504d"), warmColorsCategory, "Red"),
			new(UIColor.Parse("#f2dbdb"), warmColorsCategory, "Red, Lighter 80%"),
			new(UIColor.Parse("#e5b9b7"), warmColorsCategory, "Red, Lighter 60%"),
			new(UIColor.Parse("#d99694"), warmColorsCategory, "Red, Lighter 40%"),
			new(UIColor.Parse("#953734"), warmColorsCategory, "Red, Darker 25%"),
			new(UIColor.Parse("#632423"), warmColorsCategory, "Red, Darker 50%"),

			new(UIColor.Parse("#f79646"), warmColorsCategory, "Orange"),
			new(UIColor.Parse("#fdeada"), warmColorsCategory, "Orange, Lighter 80%"),
			new(UIColor.Parse("#fbd5b5"), warmColorsCategory, "Orange, Lighter 60%"),
			new(UIColor.Parse("#fac090"), warmColorsCategory, "Orange, Lighter 40%"),
			new(UIColor.Parse("#e36c09"), warmColorsCategory, "Orange, Darker 25%"),
			new(UIColor.Parse("#974806"), warmColorsCategory, "Orange, Darker 50%"),

			new(UIColor.Parse("#9bbb59"), coolColorsCategory, "Olive Green"),
			new(UIColor.Parse("#ebf1dd"), coolColorsCategory, "Olive Green, Lighter 80%"),
			new(UIColor.Parse("#d6e3bc"), coolColorsCategory, "Olive Green, Lighter 60%"),
			new(UIColor.Parse("#c3d69b"), coolColorsCategory, "Olive Green, Lighter 40%"),
			new(UIColor.Parse("#76923c"), coolColorsCategory, "Olive Green, Darker 25%"),
			new(UIColor.Parse("#4f6128"), coolColorsCategory, "Olive Green, Darker 50%"),

			new(UIColor.Parse("#4bacc6"), coolColorsCategory, "Aqua"),
			new(UIColor.Parse("#dbeef3"), coolColorsCategory, "Aqua, Lighter 80%"),
			new(UIColor.Parse("#b6dde8"), coolColorsCategory, "Aqua, Lighter 60%"),
			new(UIColor.Parse("#93cddc"), coolColorsCategory, "Aqua, Lighter 40%"),
			new(UIColor.Parse("#31859b"), coolColorsCategory, "Aqua, Darker 25%"),
			new(UIColor.Parse("#205867"), coolColorsCategory, "Aqua, Darker 50%"),

			new(UIColor.Parse("#8064a2"), coolColorsCategory, "Purple"),
			new(UIColor.Parse("#e5e0ec"), coolColorsCategory, "Purple, Lighter 80%"),
			new(UIColor.Parse("#ccc0d9"), coolColorsCategory, "Purple, Lighter 60%"),
			new(UIColor.Parse("#b2a2c7"), coolColorsCategory, "Purple, Lighter 40%"),
			new(UIColor.Parse("#5f497a"), coolColorsCategory, "Purple, Darker 25%"),
			new(UIColor.Parse("#3f3151"), coolColorsCategory, "Purple, Darker 50%"),

			new(UIColor.Parse("#ffffff"), neutralColorsCategory, "White"),
			new(UIColor.Parse("#f2f2f2"), neutralColorsCategory, "White, Darker 5%"),
			new(UIColor.Parse("#d8d8d8"), neutralColorsCategory, "White, Darker 15%"),
			new(UIColor.Parse("#bfbfbf"), neutralColorsCategory, "White, Darker 25%"),
			new(UIColor.Parse("#a5a5a5"), neutralColorsCategory, "White, Darker 35%"),
			new(UIColor.Parse("#7f7f7f"), neutralColorsCategory, "White, Darker 50%"),
	...
	public DelegateCommand<ColorBarGalleryItemViewModel> SetColorCommand {
		get => _setColorCommand ??= new DelegateCommand<ColorBarGalleryItemViewModel>(
			...
			canExecuteFunc: _ => Options?.IsSetColorCommandEnabled == true
		);
	}
