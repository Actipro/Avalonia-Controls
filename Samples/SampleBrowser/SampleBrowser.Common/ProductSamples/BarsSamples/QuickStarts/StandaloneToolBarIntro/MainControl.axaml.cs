...
public partial class MainControl : UserControl {
	...
	public MainControl() {
		...
		var verticalUsageCommandAdapter = new TextBoxBarManagerCommandAdapter(verticalUsageBarManager, verticalUsageTextBox);
	...
	/// </summary>
	public StandaloneToolBarViewModel VerticalUsageStandaloneToolBarViewModel { get; }

	/// <summary>
	/// The view model for the "Tool window" sample.
	/// </summary>
	public StandaloneToolBarViewModel ToolWindowStandaloneToolBarViewModel { get; }
