...
public partial class MainControl : UserControl {
	...
	private static void OpenRecentDocument(RecentDocumentItem recentDocumentItem) {
	...
	private static void OpenRecentDocumentMvvm(RecentDocumentViewModel recentDocumentViewModel) {
		// Process opening a document from the recent document control
	...
	public ICommand ClearCommandMvvm {
		get => _clearCommandMvvm ??= new DelegateCommand<object>(_ => {
	...
	public ICommand OpenCommand {
		get => _openCommand ??= new DelegateCommand<object>(param => {
	...
	public ICommand OpenCommandMvvm {
		get => _openCommandMvvm ??= new DelegateCommand<object>(param => {
			if (param is RecentDocumentItem { DataContext: RecentDocumentViewModel recentDocumentViewModel })
