...
public partial class MainControl : UserControl {
	...
	/// </summary>
	private static ColorBarGalleryItemViewModel AutomaticColorGalleryItemViewModel { get; } = new ColorBarGalleryItemViewModel(Colors.Black, category: null, "Automatic") { LayoutBehavior = BarGalleryItemLayoutBehavior.MenuItem };
								...
								new BarPopupButtonViewModel("ColorPicker") {
									...
									MenuItems = {
										(_basicUsageBarGalleryViewModel = new BarGalleryViewModel("ColorPickerGallery") {
											...
											Items = new ColorBarGalleryItemViewModel[] {
												new(Colors.Red),
												new(Colors.Orange),
												new(Colors.Yellow),
												new(Colors.Green),
												new(Colors.Blue),
												new(Colors.Purple),
												new(UIColor.Parse("#ffffff")) { Label = "White" },
												new(UIColor.Parse("#888888")) { Label = "Gray" },
												new(UIColor.Parse("#000000")) { Label = "Black" },
											}
										})
									}
								},
								...
								new BarPopupButtonViewModel("ColorPicker") {
									...
									MenuItems = {
										new BarGalleryViewModel("ColorPickerGallery") {
											...
											ItemTemplate = this.FindResource("CircleStyleGalleryItemTemplate") as IDataTemplate,
											Items = new ColorBarGalleryItemViewModel[] {
												new(Colors.Red),
												new(Colors.Orange),
												new(Colors.Yellow),
									...
									MenuItems = {
										new BarGalleryViewModel("ColorPickerGallery") {
											...
											Items = new ColorBarGalleryItemViewModel[] {
												...
												new(Colors.Black) { Label = "Automatic", Description = "LayoutBehavior = MenuItem", LayoutBehavior = BarGalleryItemLayoutBehavior.MenuItem },

												new(UIColor.Parse("#ed7d31")) { Description = "LayoutBehavior = Default" },
												new(UIColor.Parse("#a5a5a5")) { Description = "LayoutBehavior = Default" },
												new(UIColor.Parse("#ffc000")) { Description = "LayoutBehavior = Default" },
												new(UIColor.Parse("#5b9bd5")) { Description = "LayoutBehavior = Default" },
												new(UIColor.Parse("#70ad47")) { Description = "LayoutBehavior = Default" },

												new(UIColor.Parse("#fbe5d5")) { Description = "LayoutBehavior = GroupStart", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupStart },
												new(UIColor.Parse("#ededed")) { Description = "LayoutBehavior = GroupStart", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupStart },
												new(UIColor.Parse("#fff2cc")) { Description = "LayoutBehavior = GroupStart", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupStart },
												new(UIColor.Parse("#deebf6")) { Description = "LayoutBehavior = GroupStart", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupStart },
												new(UIColor.Parse("#e2efd9")) { Description = "LayoutBehavior = GroupStart", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupStart },

												new(UIColor.Parse("#f4b183")) { Description = "LayoutBehavior = GroupInner", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupInner },
												new(UIColor.Parse("#c9c9c9")) { Description = "LayoutBehavior = GroupInner", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupInner },
												new(UIColor.Parse("#ffd965")) { Description = "LayoutBehavior = GroupInner", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupInner },
												new(UIColor.Parse("#9cc3e5")) { Description = "LayoutBehavior = GroupInner", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupInner },
												new(UIColor.Parse("#a8d08d")) { Description = "LayoutBehavior = GroupInner", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupInner },

												new(UIColor.Parse("#833c0b")) { Description = "LayoutBehavior = GroupEnd", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupEnd },
												new(UIColor.Parse("#525252")) { Description = "LayoutBehavior = GroupEnd", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupEnd },
												new(UIColor.Parse("#7f6000")) { Description = "LayoutBehavior = GroupEnd", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupEnd },
												new(UIColor.Parse("#1e4e79")) { Description = "LayoutBehavior = GroupEnd", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupEnd },
												new(UIColor.Parse("#375623")) { Description = "LayoutBehavior = GroupEnd", LayoutBehavior = BarGalleryItemLayoutBehavior.GroupEnd },
	...
	/// </summary>
	public ColorPickerOptionsViewModel BasicUsageOptions { get; } = new ColorPickerOptionsViewModel() { CanCategorizeOnMenu = false, MinColumnCount = 3, MinItemLength = 20, };
	...
	/// </summary>
	public ColorPickerOptionsViewModel PreviewCommandOptions { get; } = new ColorPickerOptionsViewModel() { SelectedColor = Colors.Yellow };
	...
	/// </summary>
	public ColorPickerOptionsViewModel ShowcaseFontColorOptions { get; } = new ColorPickerOptionsViewModel() { MinColumnCount = 10, MaxColumnCount = 10 };

	/// <summary>
	/// The options view model for the "Showcase" sample's highlight color picker.
	/// </summary>
	public ColorPickerOptionsViewModel ShowcaseHighlightColorOptions { get; } = new ColorPickerOptionsViewModel() { BaseImageSmall = "TextHighlightColor16.png", MinItemLength = 30, SelectedColor = Colors.Yellow };
	...
	/// </summary>
	public ColorPickerOptionsViewModel StandardMenuItemsOptions { get; } = new ColorPickerOptionsViewModel() { MinColumnCount = 10, MaxColumnCount = 10 };
