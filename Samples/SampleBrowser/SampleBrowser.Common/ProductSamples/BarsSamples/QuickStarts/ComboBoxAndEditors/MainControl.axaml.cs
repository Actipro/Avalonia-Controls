...
public partial class MainControl : UserControl {
	...
	private static BarComboBoxViewModel SelectFirstComboBoxItem(BarComboBoxViewModel barComboBoxViewModel) {
	...
	/// </summary>
	public ComboBoxOptionsViewModel BasicComboBoxUsageOptions { get; } = new ComboBoxOptionsViewModel() { CanCategorizeOnMenu = false };
	...
	public IEnumerable ComboBoxColorItems {
		get {
			if (_comboBoxColorItems is null) {
				...
				_comboBoxColorItems = BarGalleryViewModel.CreateCollectionView(new TextBarGalleryItemViewModel[] {
						new("Red", primaryCategory) { Icon = ResolveResource<IImage>(LocalResourceKeys.RedSwatch) },
						new("Yellow", primaryCategory) { Icon = ResolveResource<IImage>(LocalResourceKeys.YellowSwatch) },
						new("Blue", primaryCategory) { Icon = ResolveResource<IImage>(LocalResourceKeys.BlueSwatch) },

						new("Orange", secondaryCategory) { Icon = ResolveResource<IImage>(LocalResourceKeys.OrangeSwatch) },
						new("Green", secondaryCategory) { Icon = ResolveResource<IImage>(LocalResourceKeys.GreenSwatch) },
						new("Purple", secondaryCategory) { Icon = ResolveResource<IImage>(LocalResourceKeys.PurpleSwatch) },
					}, categorize: true);
			}
	...
	public IEnumerable ComboBoxEnumItems {
		get => _comboBoxEnumItems ??= BarGalleryViewModel.CreateCollectionView(
	...
	public ICommand ComboBoxUnmatchedTextCommand {
		get => _comboBoxUnmatchedTextCommand ??= new DelegateCommand<string>(
			...
			canExecuteFunc: _ => {
				...
				//   typed text should be allowed... true to allow the value and false to reject it
				//
				// If the BarComboBox.UnmatchedTextCommand is unassigned, all values are assumed to be allowed
				return true;
			}
		);
	}
	...
	public ICommand TextBoxCommitCommand {
		get => _textBoxCommitCommand ??= new DelegateCommand<object>(
			executeAction: param => {
