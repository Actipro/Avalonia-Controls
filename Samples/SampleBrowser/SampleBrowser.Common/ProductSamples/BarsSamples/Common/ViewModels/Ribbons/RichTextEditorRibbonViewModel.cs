...
public class RichTextEditorRibbonViewModel : RibbonViewModel {
	...
	protected virtual RibbonBackstageViewModel? CreateBackstage(BarManager barManager)
		=> null;  // See derived types for backstage examples
