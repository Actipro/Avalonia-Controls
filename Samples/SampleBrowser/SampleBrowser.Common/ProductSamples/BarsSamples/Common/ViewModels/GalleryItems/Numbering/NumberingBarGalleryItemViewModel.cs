...
public class NumberingBarGalleryItemViewModel : BarGalleryItemViewModel<NumberingKind> {
	...
	/// <summary>
	/// Initializes an instance of the class with a default value and category using dot format.
	/// </summary>
	public NumberingBarGalleryItemViewModel()
		: this(value: default) { }

	/// <summary>
	/// Initializes an instance of the class with the specified value and a default category using dot format.
	/// </summary>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified value and category using dot format.
	/// </summary>
	/// <param name="value">The item's value.</param>
	...
	/// <summary>
	/// Initializes an instance of the class with the specified value, category, and label using dot format.
	/// </summary>
	/// <param name="value">The item's value.</param>
	/// <param name="category">The item's category, or <c>null</c> if categorization is not supported.</param>
