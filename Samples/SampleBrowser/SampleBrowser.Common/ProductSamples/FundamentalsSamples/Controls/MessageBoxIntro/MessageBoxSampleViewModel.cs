...
public class MessageBoxSampleViewModel : ObservableObjectBase {
	...
	public MessageBoxSampleViewModel() {
		...
		Text = "This is the message that will be displayed.";
	}
	...
	public bool HasCloseButton {
		get => Buttons == MessageBoxButtons.OK
			|| Buttons.HasFlag(MessageBoxButtons.Cancel)
			|| Buttons.HasFlag(MessageBoxButtons.Ignore);
	}
