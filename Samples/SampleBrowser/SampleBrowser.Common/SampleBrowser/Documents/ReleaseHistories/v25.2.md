...
## Docking
- Fixed a rare issue where an unhandled ArgumentException might be thrown when dragging non-hosted floating windows.
...
## Core Library
- Added the TrustedCodeService class that manages dynamic loading of types in a secure-by-default manner. See related documentation for details.
