...
## Themes
- Fixed an issue where the ModernTheme.RefreshResources method wouldn't properly update native and Actipro control themes for various ThemeDefinition appearance kind property changes.
## Shared Library
...
- UI accessibility peers are implemented for the entire control hierarchy.
