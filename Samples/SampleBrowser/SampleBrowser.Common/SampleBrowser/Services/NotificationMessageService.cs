...
/// </summary>
public class NotificationMessageService(WindowNotificationManager notificationManager) : IMessageService {

	private readonly WindowNotificationManager _notificationManager = notificationManager ?? throw new ArgumentNullException(nameof(notificationManager));
