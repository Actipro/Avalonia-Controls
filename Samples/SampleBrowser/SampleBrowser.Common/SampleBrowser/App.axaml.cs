...
public partial class App : Application {
	...
	public override void Initialize() {
		...
		ImageProvider.Default.RelativePathBaseUri = new Uri("avares://" + Assembly.GetExecutingAssembly().GetName().Name);
		...
		this.Styles.Insert(1, (Styles)AvaloniaXamlLoader.Load(new Uri("avares://Avalonia.Controls.ColorPicker/Themes/Fluent/Fluent.xaml")));
		this.Styles.Insert(1, (Styles)AvaloniaXamlLoader.Load(new Uri("avares://Avalonia.Controls.DataGrid/Themes/Fluent.xaml")));
		#elif SIMPLE_THEME
		...
		this.Styles.Insert(1, (Styles)AvaloniaXamlLoader.Load(new Uri("avares://Avalonia.Controls.ColorPicker/Themes/Simple/Simple.xaml")));
		this.Styles.Insert(1, (Styles)AvaloniaXamlLoader.Load(new Uri("avares://Avalonia.Controls.DataGrid/Themes/Simple.xaml")));
		#endif
